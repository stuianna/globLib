#ifndef STM32F103CB_SPI_H_
#define STM32F103CB_SPI_H_
...
/*! @file stm32f103cb_spi.h
    @brief Header file for stm32f103cb SPI
*/
...
/*! 
    ...
    @details 
    @param periph The port to modify
    @param data The frame size defined by #spi_data
    @return 
        - E_SPI_PORT if port doesn't exist.
        - E_SPI_NONE if no error.
*/
...
/*! 
    ...
    @details 
    @param periph The port to modify
    @param endian The frame order define by #spi_endian
    @return 
        - E_SPI_PORT if port doesn't exist.
        - E_SPI_NONE if no error.
*/
...
/*! 
    ...
    @param periph The port to modify
    @param phase The phase of the clock define by #spi_phase
    @return 
        - E_SPI_PORT if port doesn't exist.
        - E_SPI_NONE if no error.
*/
