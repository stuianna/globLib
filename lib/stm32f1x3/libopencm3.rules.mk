...
OBJS		+= $(BINARY).o $(patsubst %.c,%.o,$(wildcard $(COMMON_DIR)/*.c)) $(patsubst %.c,%.o,$(wildcard $(LIB_DIR)/*.c))
...
DEFS		+= -I$(OPENCM3_DIR)/include -I$(COMMON_DIR)/ -I$(LIB_DIR)/ 
LDFLAGS		+= -L$(OPENCM3_DIR)/lib   -L$(COMMON_DIR)/ -L$(LIB_DIR)/
LDLIBS		+= -l$(LIBNAME)
LDSCRIPT	?= $(BINARY).ld
else
