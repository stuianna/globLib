/*! 
    @defgroup STM32F103
    @description
    @brief Low level abstraction layer for the STMicroelectronics STM32F103 microcontroller.


    @section intro_sec Introduction

This API contains low level modules designed to interface with STM32F103 perihperals.
