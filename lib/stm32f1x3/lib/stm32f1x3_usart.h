#ifndef STM32F103C8_USART_H_
#define STM32F103C8_USART_H_
...
/**
    ...
    Following this, usart.put() and usart.get() can be used to send and recieve bytes.
    ...
    @parMinimum working example (blocking)
    @include example_usart_min.c

    @parMinimum working example (interrupts)
...
/*! @file stm32f1x3_usart.h
    @brief Header file for stm32f103 USART
*/
...
/*! 
    ...
    @return Error number as defined in #usart_error.
*/
