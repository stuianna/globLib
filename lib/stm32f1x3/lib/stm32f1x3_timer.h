#ifndef STM32F103C8_TIMERS_H_
#define STM32F103C8_TIMERS_H_
...
/*! @file stm32f1x3_timer.h
    @brief Header file for stm32f103 timers
*/
...
/*! 
    ...
    @param timerNumber The timer number to setup
    @param timerChannel The channel of that timer to use.
    @param frequncy The frequncy of the signal.
...
/*! 
    ...
    @param timerNumber The timer number to setup
    @param timerChannel The channel of that timer to use.
    @param period The period of the total time.
...
/*! 
    ...
    @param timerNumber The timer number to modify
    @param timerChannel The timer chanel to modify
