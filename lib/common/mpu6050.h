...
/*! 
    ...
    @param i2c_numer The number of the peripheral port connected, typically I2C_1 or I2C_2
    @param The slave address of the device MPU_DEVICE_ADDRESS or MPU_DEVICE_ADDRESS_ALTERNATE
